            ...
            <div className='flex justify-between px-5 pt-2'>
              {['Layout1', 'Layout2'].map((ele: any, index) => {
                return (
                  <div
                    key={ele}
                    className='w-1/2 flex flex-col gap-3 justify-center items-center cursor-pointer'
                    onClick={() => {
                      setLayout(ele)
                    }}
                  >
                    {ele === 'Layout1' ? (
                      <Image
                        alt='layout'
                        src={require('@/assets/svg/layout1/lo.svg')}
                      />
                    ) : (
                      <Image
                        alt='layout'
                        src={require('@/assets/svg/layout2/lo.svg')}
                      />
                    )}
