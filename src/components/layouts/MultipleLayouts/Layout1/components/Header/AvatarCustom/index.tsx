...
import { BACK_GROUND, BLACK, BLUE, GRAY, GRAY_SCALE, GREEN, GREY, ORANGE, RED, WHITE } from '@/helper/colors'
...
import { DemoMode } from '@/components/layouts/MultipleLayouts/Layout1/components/Header/AvatarCustom/DemoMode'
...
export const AvatarCustom = ({
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col w-155 h-full pb-5">
          <div
